...
namespace Moralis.Web3Api.Client
{
    ...
    public class ApiClient
    {
        ...
        public async UniTask<HttpResponseMessage> CallApi(String path, HttpMethod method, String postBody,
            Dictionary<String, String> headerParams, Dictionary<String, String> queryParams, String[] authSettings)
        {
            ...
            //UniTask<HttpResponseMessage> restTask = UniTask.Run(() =>
            //{
            //    return RestClient.SendAsync(request);
            //});

            return await RestClient.SendAsync(request);//await restTask;
        }
        ...
        public async UniTask<Object> CallApi(String path, HttpMethod method, Dictionary<String, String> queryParams, String postBody,
        ...
        public async UniTask<object> Deserialize(HttpContent content, Type type, HttpResponseHeaders headers = null)
        {
