...
namespace Moralis.Web3Api.Interfaces
{
	...
	public interface ITokenApi
	{
		...
		Task<TradeCollection> GetNFTTrades (string address, ChainList chain, string cursor = "", int? fromBlock=null, string toBlock=null, string fromDate=null, string toDate=null, string providerUrl=null, string marketplace=null, int? limit=null);
		...
		Task<NftMetadataCollection> SearchNFTs (string q, ChainList chain, string cursor = "", string format =null, string filter=null, int? fromBlock=null, int? toBlock=null, string fromDate=null, string toDate=null, int? limit=null);
		...
		Task<NftTransferCollection> GetNftTransfersFromToBlock (ChainList chain, string cursor = "", int? fromBlock=null, int? toBlock=null, string fromDate=null, string toDate=null, string format=null, int? limit=null);
		...
		Task<NftCollection> GetAllTokenIds (string address, ChainList chain, string cursor = "", string format=null, int? limit=null);
		...
		/// <param name="limit">limit</param>
		/// <returns>Returns a collection of NFT transfers</returns>
		Task<NftTransferCollection> GetContractNFTTransfers (string address, ChainList chain, string cursor = "", string format=null, int? limit=null);
		...
		Task<NftOwnerCollection> GetNFTOwners (string address, ChainList chain, string cursor = "", string format=null, int? limit=null);
		...
		Task<NftOwnerCollection> GetTokenIdOwners (string address, string tokenId, ChainList chain, string cursor = "", string format=null, int? limit=null);
		...
		/// <returns>Returns a collection of NFT transfers</returns>
		Task<NftTransferCollection> GetWalletTokenIdTransfers (string address, string tokenId, ChainList chain, string cursor = "", string format=null, int? limit=null, string order=null);
